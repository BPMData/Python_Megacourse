...
from Modules.Functions_Day16_GUI import get_save, write_save, ord, FILEPATH
...
while True:
    ...
    todos = get_save(filepath=FILEPATH)
    todo = ()
    if list_decision[0] == "add":
        ...
        if len(list_decision) > 1:
            ...
            while True:
                ...
                try:
                    ...
                    write_save(todos_arg=todos, filepath = FILEPATH) # You can put the arguments in the 'wrong' order if you specify them precisely.
        ...
        if reset_choice == "yes":
            with open(FILEPATH, "w+") as savefile:  #wow, w+ is dope
                savefile.write("")
